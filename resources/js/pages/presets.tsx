                        ...
                        {presets.map((preset) => {
                            ...
                            return (
                                <Card
                                    key={preset.id}
                                    onClick={(e) => handleCardClick(preset.id, e)}
                                    className={`flex flex-col md:flex-row overflow-hidden cursor-pointer hover:shadow-lg transition-shadow duration-200 ${isPremium ? "border-emerald-500" : ""
                                        }`}
                                >
