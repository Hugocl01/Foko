...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    // Luego añadiremos la publicación actual como breadcrumb
]
...
export default function PublicationShow() {
    ...
    const [likesCount, setLikesCount] = useState<number>(0) // Puedes inicializar desde pub.likes_count si viene del backend
    ...
    const toggleLike = () => {
        ...
        // Aquí iría tu llamada al servidor, p. ej.:
        // router.post(route("publications.like", pub.id))
    }

    const toggleSave = () => {
        setSaved((prev) => !prev)
        // Aquí podrías llamar a la ruta de “guardar publicación” en el servidor
    }
            ...
            <div className="flex flex-col gap-4 p-4 max-w-2xl mx-auto">
                ...
                <Card className="flex flex-col h-full">
                    ...
                    <CardFooter className="flex flex-col items-start gap-4 p-4">
                        ...
                        {/* — Datos del preset aplicado — */}
                        <div className="w-full border-t pt-4 flex flex-col gap-2">
                            <div className="text-sm font-medium">Preset aplicado:</div>
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                <div>
                                    <div className="font-semibold">{pub.preset.name}</div>
                                    <div className="text-xs text-muted-foreground">
                                        {pub.preset.description}
                                    </div>
                                </div>
                                <div className="text-sm font-medium">
                                    Precio: ${pub.preset.price}
                                </div>
                            </div>
                        </div>
                    </CardFooter>
