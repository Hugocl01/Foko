                        ...
                        <Card className="flex flex-col h-full">
                                ...
                                <div className="px-4 pb-2">
                                    <div className="grid grid-cols-2 gap-3">
                                        {(["before", "after"] as const).map((mode) => (
                                            <div
                                                key={mode}
                                                className={`cursor-pointer rounded-lg overflow-hidden border-2 transition-all duration-200 ${viewMode === mode ? "border-primary shadow-md" : "border-gray-200 hover:border-gray-300"
                                                    }`}
                            ...
                            <CardFooter className="flex flex-col items-start gap-3 p-4 pt-0">
                                ...
                                {hasPurchased ? (
                                    ...
                                    <Button variant={"default"} size="sm" className="w-full" onClick={handlePurchase}>
                        ...
                        <Card>
                            <CardContent className="px-4">
                                <div className="text-center space-y-4">
                                    {hasPurchased && (
                                        <Badge className="bg-green-500 text-white">Comprado</Badge>
                                    )}
                                    ...
                                    {hasPurchased ? (
                                        ...
                                        <Button variant={"default"} size="lg" className="w-full" onClick={handlePurchase}>
