...
// Definición de Preset con id:number
type Preset = {
    id: number
    name: string
}
...
export function PostDialog({
    ...
    // Sincronizar initialData cada vez que se abra el diálogo
    useEffect(() => {
        if (isDialogOpen) {
            setFormData({
                id: initialData?.id || "",
    ...
    const handleWrapperClick = () => {
        if (formData.images.length < maxImages) fileInputRef.current?.click()
    }
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        // Validaciones: título y descripción siempre, imágenes sólo en creación
        if ((!isEditing && formData.images.length === 0) || !formData.title || !formData.description) return
        onSubmit(formData)
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {isEditing ? "Modifica tu publicación existente." : "Completa la información para publicar."}
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        ...
                        <TabsContent value="info" className="space-y-4 pt-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    value={formData.preset_id?.toString() || ""}
