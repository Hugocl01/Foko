...
export function PresetDialog({
    ...
    // Creamos un objeto "initialForm" a partir de initialData (o valores por defecto)
    ...
    // Manejamos el estado "open" (controlado o no)
    ...
    // Si initialData cambia (por ejemplo: abrimos el diálogo de edición con otro preset), actualizamos formData
    useEffect(() => {
    ...
    // Ahora acepta File | null para poder borrar el archivo al hacer clic en la "X"
    const handleFileUpload = (
        field: keyof Omit<PresetFormData, "name" | "description" | "price" | "hashtags">,
        file: File | null
    ) => {
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {(((formData[field] as File)?.size ?? 0) / 1024 / 1024).toFixed(2)} MB
                            </p>
                        </div>
                    </div>
                    <Button
