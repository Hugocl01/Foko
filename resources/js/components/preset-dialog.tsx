...
export function PresetDialog({
    ...
    const handleFileUpload = (field: "file" | "before_image" | "after_image", file: File) => {
    ...
    const handleDrop = (e: React.DragEvent, field: "file" | "before_image" | "after_image") => {
        e.preventDefault()
        e.stopPropagation()
        setDragActive(null)
            ...
            {formData[field] ? (
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-medium text-sm">{formData[field]?.name}</p>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    ...
                    <TabsContent value="files" className="space-y-4 pt-4">
                        ...
                        <Alert className="mb-4">
                            <AlertDescription>Arrastra y suelta los archivos o haz clic para seleccionarlos.</AlertDescription>
                        </Alert>
